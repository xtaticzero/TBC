...
public class RfcValidador implements Validator {
    ...
    /**
     * Procesa por medio de filtros (expresiones regulares) la entrada de datos
     * que se obtiene de la vista, valida que el texto ingresado tenga formato
     * de RFC, en caso contrario genera un mensaje de error a nivel de pantalla.
     *
